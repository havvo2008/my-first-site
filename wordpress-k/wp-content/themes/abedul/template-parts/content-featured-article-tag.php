...
<article id="post-<?php the_ID(); ?>" <?php post_class('featured-article-tag'); ?> >
	...
	<?php endif ?>
			...
			<header class="entry-header">
				<?php if ( is_sticky() && (is_home() || is_front_page()) && ! is_paged() || is_archive() ) :
...
<?php endif ?>
	...
	<?php abedul_related_posts_by_tag( $post ); ?>
